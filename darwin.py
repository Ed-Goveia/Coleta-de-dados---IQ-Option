            ...
            if doji_lu <= 1:
                ...
                if doji_lu == 0:
                    ...
                    if r_a == 10:
                        ...
                        if r == 3:
                            if g_t == 2 and r_last == 1 and g_one == 1: signal = 'call'
                        if g == 3:
                            if r_t == 2 and g_last == 1 and r_one == 1: signal = 'call'
                        else: signal = 'put'

                    if g_a == 10: 
                        
                        if r == 3:
                            if g_t == 2 and r_last == 1 and g_one == 1: signal = 'put'
                        if g == 3:
                            if r_t == 2 and g_last == 1 and r_one == 1: signal = 'put'
                        else: signal = 'call'
                ...
                if doji_lu == 1:
                    ...
                    if r_a == 9 : 
                        if g == 3:
                            if g_last == 2 and g_t == 2 and r_q == 2: signal = 'call'
                        if r == 3:
                            if r_last == 2 and r_t ==2 and g_q == 2: signal = 'call'
                        else: signal = 'put'
                    if g_a == 9 :
                        if g == 3:
                            if g_last == 2 and g_t == 2 and r_q == 2: signal = 'put'
                        if r == 3:
                            if r_last == 2 and r_t ==2 and g_q == 2: signal = 'put'
                        else: signal = 'call'
                else:
                    if g_a < 9 and r_a < 9:
                            ...
                            if r_t < 3:
                                ...
                                if r == 3:
                                    ...
                                    if r_q == 2 and r_t==2 and g_one == 1 and g_q == 2: 
                                        if solar is not None: signal = solar
                                        else: signal = 'put'
